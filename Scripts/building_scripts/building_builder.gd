...
var array = [preload("res://Scenes/buildings/building_orphanage.tscn"), preload("res://Scenes/buildings/building_oldhome.tscn"),preload("res://Scenes/buildings/building_petshop.tscn")]
...
func inst(pos):
	var rng_Floors = rng.randi_range(0,2)
