...
var thrown_object = [preload("res://Scenes/falling_object.tscn"),preload("res://Scenes/falling_grandpa.tscn")]
...
func inst(pos):
	var instance = thrown_object[randi_range(0,1)].instantiate();
